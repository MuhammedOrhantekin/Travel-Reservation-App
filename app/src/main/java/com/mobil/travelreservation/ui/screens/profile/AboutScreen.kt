 ...
 * AboutScreen
 *
 * Uygulamanın "Hakkında" sayfasıdır.
 * Projenin amacı, kullanılan teknolojiler ve geliştirici ekibin bilgilerini içerir.
 *
 * İşlevleri:
 * 1. Proje Tanıtımı (Ne işe yarar?)
 * 2. Özellik Listesi (Hangi fonksiyonlar var?)
 * 3. Teknoloji Stack'i (Hangi kütüphaneler kullanıldı?)
 * 4. Geliştirici Künyesi (Projeyi kim yaptı?)
 */
    ...
    Scaffold(
        ...
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(padding)
                .verticalScroll(rememberScrollState()) // İçerik uzun olduğu için kaydırma gerekli
                .padding(16.dp),
 ...
 * FeatureItem
 *
 * "Özellikler" listesindeki her bir madde için kullanılan yardımcı bileşen.
 * @param icon Özelliği temsil eden ikon.
 * @param text Özellik açıklaması.
 */
@Composable
 ...
 * TechItem
 *
 * "Kullanılan Teknolojiler" listesindeki her bir madde için yardımcı bileşen.
 * @param name Teknolojinin adı (Örn: Kotlin).
 * @param description Teknolojinin kullanım amacı (Örn: Programlama dili).
 */
@Composable
fun TechItem(name: String, description: String) {
    Row(
        ...
        Icon(
            ...
            tint = Color(0xFF4CAF50) // Yeşil tik işareti
        )
